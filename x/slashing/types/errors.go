...
var (
	ErrNoValidatorForAddress        = sdkerrors.Register(ModuleName, 1, "")
	ErrBadValidatorAddr             = sdkerrors.Register(ModuleName, 2, "")
	ErrValidatorJailed              = sdkerrors.Register(ModuleName, 3, "")
	ErrValidatorNotJailed           = sdkerrors.Register(ModuleName, 4, "")
	ErrMissingSelfDelegation        = sdkerrors.Register(ModuleName, 5, "")
	ErrSelfDelegationTooLowToUnjail = sdkerrors.Register(ModuleName, 6, "")
	ErrNoSigningInfoFound           = sdkerrors.Register(ModuleName, 7, "")
)
